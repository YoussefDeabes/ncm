...
class ConstColors {
  ...
  static const _appMercury = Color(0xffF7F7F7);
  ...
  static const accent = Color(0xffD0902B);
  static const text = Color(0xff4A5051);
  static const textGrey = Color(0xff707070);
  static const textBlack = Color(0xff383838);
  static const textSecondary = Color.fromARGB(255, 117, 117, 117);
  static const textDisabled = Color(0xffA0A0A0);
  static const textLightGrey = Color(0xff8D8D8D);
  ...
  static const scaffoldBackground = _appMercury;
